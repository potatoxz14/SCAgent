...
from inference_agent_E import Perceptor, DEFAULT_PERCEPTION_ARGS, ADB_PATH, INIT_TIPS, INIT_SHORTCUTS, REASONING_MODEL, save_found_actions_for_run
import torch
import os
import json
import shutil
...
def main():
    ...
    # Stage-1: extract discovered sensitive actions from each task's steps.json trajectory
    try:
        save_found_actions_for_run(args.log_root, args.run_name)
    except Exception as e:
        print("WARNING: found_actions extraction failed:", e)
